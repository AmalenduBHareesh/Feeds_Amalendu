...
class Newarc extends StatefulWidget {
  const Newarc({super.key});

  @override
  State<Newarc> createState() => _NewarcState();
}

class _NewarcState extends State<Newarc> {
  // List of dummy data (you can replace this with your real data)
  final List<Map<String, String>> NewarcItems = [
    {
      'title':
  ...
  void initState() {
    ...
    _isBookmarked = List<bool>.filled(NewarcItems.length, false);
  }
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(
          itemCount: NewarcItems.length,
          itemBuilder: (context, index) {
            final item = NewarcItems[index];
            return Padding(
